...
class Shader {
  protected:
    ...
    /*!
     * Path to tesselation control shader and tesselation evaluation shader
     */
    std::string _tcs, _tes;
    ...
    /*!
     * Checks if tesselation shader are used in the shared shader pointer
     */
    bool usesTessellation = false;
  ...
  public:
    ...
    bool isTessellationShader() const { return usesTessellation; };
